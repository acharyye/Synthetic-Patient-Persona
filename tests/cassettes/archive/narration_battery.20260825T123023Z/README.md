# Archived cassette: narration_battery

Archived 20260825T123023Z by `record_narration.py --rerecord`.
...
Files: narration_battery.json, narration_battery.compliance.json
